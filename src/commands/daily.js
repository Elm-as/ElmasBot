...
export async function cmdDaily(sock, msg) {
  ...
  // Feedback immédiat
  await sock.sendMessage(groupJid, { text: '🔎 Traitement du daily bonus en cours... ⏳', quoted: msg })
  ...
  if (last && now - last < ONE_DAY) {
    ...
    return sock.sendMessage(groupJid, { text: `⏳ Daily déjà pris. Reviens dans ~${leftH}h.`, quoted: msg })
  }
